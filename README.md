...
## Season 2 준비 (2026.03.21 ~ )
- **Bitcopark Organization** 생성 및 기존 레포지토리 마이그레이션
- 시즌 1의 성과를 바탕으로 더 체계적인 스터디를 진행

# Season 1 (2024.11.12 ~ 2026.03.21)

## 깊이있는 개발자가 되기 위한 스터디

- 깊이있는 개발자가 될때까지 동안 진행되는 **CS & Spring boot 학습 & Spring MVC 프로젝트 리팩토링** 입니다.
- 매 주 **✔월요일 오전11:00** 까지 Jira를 통해 주어진 학습 목표를 완료하고, 광진구 1인 가구 센터에 모여서 5~6시간 동안 스터디를 진행합니다.
...
- [21주차](/Recap/Week21.md)
  - 개인 프로젝트에 대한 발표, 논의 진행
  - 같이 진행할 프로젝트 논의(법원 동산 경매 API를 이용한 서비스)

- ~21주차 이후(2025.05.01 ~ 2026.03.21)
  - 각자가 흥미있는 분야를 공부한 후 이를 공유하는 스터디로 변경(1~2주 텀)
  - 각자 스터디 한 내용으로 발표/논의를 진행
  - 2026.03.21까지 진행을 bitcopark season 1로 마감하고, github organization 생성 후 기존 프로젝트 마이그레이션 이후 시즌2를 진행 예정
